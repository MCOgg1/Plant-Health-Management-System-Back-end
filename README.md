...
- Use of Matplotlib for retrieved data to be displayed in Line and Bar chart graph formats
- Linked CSV containing common house plants for comparison between recorded / ideal values for common British house plants
- In-memory image handling through base64 encoding for data to be returned to the Front-end
...
- Leant how to set up basic interactions between HTML front-end and my Python back-end
- Learnt how to set up interactions between different project compartments (HTML, Rust, The Pi Itself)
- Helped sharpen teamwork skills and uphold communication between members
